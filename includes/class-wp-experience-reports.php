...
class Wp_Experience_Reports {
	...
	public function __construct() {
		if ( defined( 'WP_EXPERIENCE_REPORTS_VERSION' ) ) {
			$this->version = WP_EXPERIENCE_REPORTS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wp_Experience_Reports_Admin( $this->get_plugin_name(), $this->get_version() );
